...
const PUBLIC_SCRIPT_EVENTS = [
    ...
    "bounty:teleport", "bounty:test_capture", "bounty:train", "rae:adopt", "rae:aim_spike", "rae:debug", "rae:menu", "rae:probe_damage", "rae:reset",
...
test("main.js loads under the fake game API and registers every system", () => {
    ...
    check("core systems are registered", ["roles", "jail", "jailbreak", "raids", "train", "transit", "aimprobe", "menu", "boat", "guns", "compass", "endgame"].every((n) => names.includes(n)), names.join(","));
    done();
});
